...
const UI = {
  en: {
    ...
    membershipHeading: "Membership Status", membershipSub: "Enter your NRIC number to check your temple membership status.",
    membershipInputLabel: "NRIC Number", membershipPlaceholder: "XXXXXX-XX-XXXX",
    membershipCheckBtn: "Check Status", membershipChecking: "Checking…",
    membershipHint: "Format: XXXXXX-XX-XXXX (numbers only)",
    membershipInvalidFormat: "Please enter a valid NRIC in the format XXXXXX-XX-XXXX.",
    membershipNotFound: "No membership record was found for this NRIC.",
    membershipError: "Something went wrong. Please try again in a moment.",
    membershipResultName: "Name", membershipResultNric: "NRIC", membershipResultNo: "Membership No.",
  ...
  bm: {
    ...
    membershipHeading: "Status Keahlian", membershipSub: "Masukkan nombor NRIC anda untuk menyemak status keahlian kuil anda.",
    membershipInputLabel: "Nombor NRIC", membershipPlaceholder: "XXXXXX-XX-XXXX",
    membershipCheckBtn: "Semak Status", membershipChecking: "Menyemak…",
    membershipHint: "Format: XXXXXX-XX-XXXX (nombor sahaja)",
    membershipInvalidFormat: "Sila masukkan NRIC yang sah dalam format XXXXXX-XX-XXXX.",
    membershipNotFound: "Tiada rekod keahlian dijumpai untuk NRIC ini.",
    membershipError: "Sesuatu tidak kena. Sila cuba lagi sebentar.",
    membershipResultName: "Nama", membershipResultNric: "NRIC", membershipResultNo: "No. Keahlian",
  ...
  ta: {
    ...
    membershipHeading: "உறுப்பினர் நிலை", membershipSub: "உங்கள் கோயில் உறுப்பினர் நிலையைச் சரிபார்க்க உங்கள் NRIC எண்ணை உள்ளிடவும்.",
    membershipInputLabel: "NRIC எண்", membershipPlaceholder: "XXXXXX-XX-XXXX",
    membershipCheckBtn: "நிலையைச் சரிபார்க்க", membershipChecking: "சரிபார்க்கிறது…",
    membershipHint: "வடிவம்: XXXXXX-XX-XXXX (எண்கள் மட்டும்)",
    membershipInvalidFormat: "XXXXXX-XX-XXXX வடிவத்தில் சரியான NRIC ஐ உள்ளிடவும்.",
    membershipNotFound: "இந்த NRIC க்கு உறுப்பினர் பதிவு எதுவும் கிடைக்கவில்லை.",
    membershipError: "ஏதோ தவறு நடந்தது. சிறிது நேரத்தில் மீண்டும் முயற்சிக்கவும்.",
    membershipResultName: "பெயர்", membershipResultNric: "NRIC", membershipResultNo: "உறுப்பினர் எண்",
