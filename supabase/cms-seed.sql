...
--
-- Run this ONCE, after cms-schema.sql, in the Supabase SQL Editor.
-- Re-running it will duplicate rows in the list tables (deities,
-- sevas, announcements, gallery, pooja_timings, nav_tiles) — the
-- singleton tables (hero_banner/about_page/contact_info) use
-- upsert and are safe to re-run. If you need to start over, run:
--   delete from deities; delete from sevas; delete from announcements;
--   delete from gallery; delete from pooja_timings; delete from nav_tiles;
-- first.
-- ============================================================
...
insert into deities (name_en, name_bm, name_ta, role_en, role_bm, role_ta, description_en, description_bm, description_ta, image_url, color, sort_order) values ('Sri Bairavar', 'Sri Bairavar', 'ஸ்ரீ பைரவர்', 'Guardian Deity', 'Dewa Penjaga', 'காவல் தெய்வம்', 'A fierce guardian form of Lord Shiva, worshipped as protector of the temple and its boundaries.', 'Wujud garang Dewa Siva, disembah sebagai penjaga kuil dan sempadannya.', 'சிவபெருமானின் உக்கிர வடிவம், கோயிலையும் அதன் எல்லைகளையும் காக்கும் காவல் தெய்வமாக வழிபடப்படுபவர்.', 'https://lh3.googleusercontent.com/d/1Uy8dRxgf5UJJS8vuqi4F4Geafg_ekaDF=w800', '#3B3B3B', 10);
insert into deities (name_en, name_bm, name_ta, role_en, role_bm, role_ta, description_en, description_bm, description_ta, image_url, color, sort_order) values ('Navagraham', 'Navagraham', 'நவகிரகம்', 'Nine Planetary Deities', 'Sembilan Dewa Planet', 'நவகிரக தெய்வங்கள்', 'The nine celestial deities governing destiny, worshipped together to balance their planetary influences.', 'Sembilan dewa cakerawala yang menentukan takdir, disembah bersama untuk mengimbangi pengaruh planet masing-masing.', 'விதியை நிர்ணயிக்கும் நவகிரக தெய்வங்கள், அவற்றின் கிரக பாதிப்புகளை சமன்செய்ய ஒன்றாக வழிபடப்படுகின்றன.', 'https://lh3.googleusercontent.com/d/1BaEizVgGNr0AktWyM-4Cjr48HBxPWs-T=w800', '#2E6F4E', 11);

-- ---------- pooja_timings (live sheet content, EN/BM/TA merged per row) ----------
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('today', 'Nadai Thirappu', 'Pembukaan Pintu Kuil', 'நடைத் திறப்பு', '5:30 AM', 0);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('today', 'Ushakala Pooja', 'Pooja Subuh', 'உஷக்கால பூஜை', '6:00 AM', 1);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('today', 'Kalasanthi Pooja', 'Pooja Pagi', 'காலசந்தி பூஜை', '8:30 AM', 2);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('today', 'Uchikala Pooja', 'Pooja Tengah Hari', 'உச்சிகால பூஜை', '12:00 PM', 3);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('today', 'Sayaraksha Pooja', 'Pooja Petang', 'சாயரட்சை பூஜை', '6:00 PM', 4);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('today', 'Arthajama Pooja', 'Pooja Malam', 'அர்த்தஜாம பூஜை', '8:30 PM', 5);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('daily', 'Nadai Thirappu', 'Pembukaan Pintu Kuil', 'நடைத் திறப்பு', '5:30 AM', 0);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('daily', 'Ushakala Pooja', 'Pooja Subuh', 'உஷக்கால பூஜை', '6:00 AM', 1);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('daily', 'Kalasanthi Pooja', 'Pooja Pagi', 'காலசந்தி பூஜை', '8:30 AM', 2);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('daily', 'Uchikala Pooja', 'Pooja Tengah Hari', 'உச்சிகால பூஜை', '12:00 PM', 3);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('daily', 'Sayaraksha Pooja', 'Pooja Petang', 'சாயரட்சை பூஜை', '6:00 PM', 4);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('daily', 'Arthajama Pooja', 'Pooja Malam', 'அர்த்தஜாம பூஜை', '8:30 PM', 5);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('friday', 'Nadai Thirappu', 'Pembukaan Pintu Kuil', 'நடைத் திறப்பு', '5:00 AM', 0);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('friday', 'Special Abhishekam', 'Abhishekam Khas', 'சிறப்பு அபிஷேகம்', '7:00 AM', 1);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('friday', 'Kalasanthi Pooja', 'Pooja Pagi', 'காலசந்தி பூஜை', '8:30 AM', 2);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('friday', 'Uchikala Pooja', 'Pooja Tengah Hari', 'உச்சிகால பூஜை', '12:00 PM', 3);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('friday', 'Sayaraksha Pooja', 'Pooja Petang', 'சாயரட்சை பூஜை', '6:00 PM', 4);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('friday', 'Deepa Aradhanai', 'Deepa Aradhanai', 'தீப ஆராதனை', '7:30 PM', 5);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('friday', 'Arthajama Pooja', 'Pooja Malam', 'அர்த்தஜாம பூஜை', '9:00 PM', 6);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('fullMoon', 'Nadai Thirappu', 'Pembukaan Pintu Kuil', 'நடைத் திறப்பு', '5:00 AM', 0);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('fullMoon', 'Special Abhishekam', 'Abhishekam Khas', 'சிறப்பு அபிஷேகம்', '6:30 AM', 1);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('fullMoon', 'Kalasanthi Pooja', 'Pooja Pagi', 'காலசந்தி பூஜை', '8:30 AM', 2);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('fullMoon', 'Annadhanam', 'Annadhanam', 'அன்னதானம்', '12:30 PM', 3);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('fullMoon', 'Sayaraksha Pooja', 'Pooja Petang', 'சாயரட்சை பூஜை', '6:00 PM', 4);
insert into pooja_timings (list_type, name_en, name_bm, name_ta, time_label, sort_order) values ('fullMoon', 'Arthajama Pooja', 'Pooja Malam', 'அர்த்தஜாம பூஜை', '9:00 PM', 5);
...
insert into sevas (name_en, name_bm, name_ta, price_en, price_bm, price_ta, desc_en, desc_bm, desc_ta, cta_en, cta_bm, cta_ta, sort_order) values ('Abhishekam Sponsorship', 'Penajaan Abhishekam', 'அபிஷேக நிதியுதவி', 'RM 100', 'RM 100', 'RM 100', 'Sponsor the sacred bathing ritual for a chosen deity on a date of your choice.', 'Taja upacara pemandian suci untuk dewa pilihan anda pada tarikh pilihan anda.', 'நீங்கள் தேர்ந்தெடுக்கும் நாளில் ஒரு தெய்வத்திற்கு புனித அபிஷேகத்தை நிதியுதவி செய்யுங்கள்.', 'Sponsor Abhishekam', 'Taja Abhishekam', 'அபிஷேகத்திற்கு நிதியுதவி செய்ய', 1);
insert into sevas (name_en, name_bm, name_ta, price_en, price_bm, price_ta, desc_en, desc_bm, desc_ta, cta_en, cta_bm, cta_ta, sort_order) values ('Annadhanam Sponsorship', 'Penajaan Annadhanam', 'அன்னதான நிதியுதவி', 'RM 500', 'RM 500', 'RM 500', 'Sponsor a full day''s community meal for visiting devotees.', 'Taja hidangan makanan komuniti sepanjang hari untuk penganut yang datang melawat.', 'வருகை தரும் பக்தர்களுக்கு ஒரு நாள் முழு உணவை நிதியுதவி செய்யுங்கள்.', 'Sponsor Annadhanam', 'Taja Annadhanam', 'அன்னதானத்திற்கு நிதியுதவி செய்ய', 2);
...
insert into announcements (title_en, title_bm, title_ta, desc_en, desc_bm, desc_ta, published, sort_order) values ('Car Park Notice', 'Notis Tempat Letak Kereta', 'கார் பார்க்கிங் அறிவிப்பு', 'Overflow parking is available at the community hall on festival days.', 'Tempat letak kereta tambahan disediakan di dewan komuniti pada hari perayaan.', 'திருவிழா நாட்களில் கூடுதல் வாகன நிறுத்துமிடம் சமூக மண்டபத்தில் கிடைக்கும்.', true, 3);

-- ---------- gallery (bundled captions; no photos uploaded yet — add via the CMS Gallery tab) ----------
insert into gallery (image_url, category_en, category_bm, category_ta, label_en, label_bm, label_ta, sort_order) values ('', 'Festivals', 'Perayaan', 'திருவிழாக்கள்', 'Thaipusam Procession', 'Perarakan Thaipusam', 'தைப்பூசம் ஊர்வலம்', 0);
insert into gallery (image_url, category_en, category_bm, category_ta, label_en, label_bm, label_ta, sort_order) values ('', 'Festivals', 'Perayaan', 'திருவிழாக்கள்', 'Navarathri Golu', 'Navarathri Golu', 'நவராத்திரி கொலு', 1);
insert into gallery (image_url, category_en, category_bm, category_ta, label_en, label_bm, label_ta, sort_order) values ('', 'Deities', 'Dewa-Dewi', 'தெய்வங்கள்', 'Murugan Alankaram', 'Alankaram Murugan', 'முருகன் அலங்காரம்', 2);
insert into gallery (image_url, category_en, category_bm, category_ta, label_en, label_bm, label_ta, sort_order) values ('', 'Deities', 'Dewa-Dewi', 'தெய்வங்கள்', 'Ganesha Shrine', 'Kuil Ganesha', 'விநாயகர் ஆலயம்', 3);
insert into gallery (image_url, category_en, category_bm, category_ta, label_en, label_bm, label_ta, sort_order) values ('', 'Temple', 'Kuil', 'கோயில்', 'Main Gopuram', 'Gopuram Utama', 'முதன்மை கோபுரம்', 4);
insert into gallery (image_url, category_en, category_bm, category_ta, label_en, label_bm, label_ta, sort_order) values ('', 'Temple', 'Kuil', 'கோயில்', 'Inner Sanctum', 'Bilik Suci Dalam', 'உள் கருவறை', 5);
insert into gallery (image_url, category_en, category_bm, category_ta, label_en, label_bm, label_ta, sort_order) values ('', 'Community', 'Komuniti', 'சமூகம்', 'Annadhanam Hall', 'Dewan Annadhanam', 'அன்னதான மண்டபம்', 6);
insert into gallery (image_url, category_en, category_bm, category_ta, label_en, label_bm, label_ta, sort_order) values ('', 'Community', 'Komuniti', 'சமூகம்', 'Cultural Class', 'Kelas Kebudayaan', 'பண்பாட்டு வகுப்பு', 7);
