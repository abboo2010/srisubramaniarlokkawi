...
-- ---------- page_headings: one fixed row per screen, seeded with the
-- exact text every screen already showed (the site's bundled default
-- in data.js), so editing here changes nothing until you actually
-- type something new. ----------
...
-- ---------- menu_labels: one fixed row per side-menu item, seeded
-- with the exact text every menu item already showed (the site's
-- bundled default in data.js), so editing here changes nothing until
-- you actually type something new. ----------
